...
const AnimatedGallery = ({ direction, pic, form }) => {
  ...
  return (
    <div className="animated-gallery-container">
      <div
        className={`animated-gallery-pic ${isVisible ? "visible" : ""}`}
        style={{
          transform:
            direction === "left"
              ? "translateX(-100%)"
      ...
      <img
          className={`picAnimatedGallery-two ${isVisible ? "animation":""}`}
          src={pic}
          style={{ borderRadius: form === "circle" ? "100%" : "0%" }}
        />
    </div>
